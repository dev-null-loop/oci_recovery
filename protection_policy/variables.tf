variable "backup_retention_period_in_days" {
  description = "The maximum number of days to retain backups for a protected database."
  type        = number
}
...
variable "display_name" {
  description = "A user provided name for the protection policy. The 'displayName' does not have to be unique, and it can be modified. Avoid entering confidential information."
  type        = string
}
